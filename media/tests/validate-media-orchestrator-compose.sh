...
assert_yq '.services.download-runner.environment.MEDIA_REZKA_STAGING_ROOT == "/data/internal/media-orchestrator/staging/rezka" and .services.download-runner.environment.MEDIA_REZKA_TV_ROOT == "/data/internal/media/rezka/tv" and .services.download-runner.environment.MEDIA_REZKA_MOVIES_ROOT == "/data/internal/media/rezka/movies"' \
